<template>
  <footer class="bg-gray-50  border-t border-gray-200  mt-8 pb-24 md:pb-8">
      ...
      <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
        ...
        <div class="space-y-3">
          <div class="flex items-center gap-2">
            ...
            <span class="font-bold text-gray-900 ">{{ storeName }}</span>
          </div>

          <div v-if="phone" class="flex items-center gap-2 text-sm text-gray-600 ">
            <PhoneIcon class="w-4 h-4 flex-shrink-0" />
            <a :href="`tel:${phone}`" class="hover:text-gray-900  transition-colors">
              {{ phone }}
            </a>
          </div>

          <div v-if="address" class="flex items-start gap-2 text-sm text-gray-600 ">
        ...
        <div class="space-y-2.5">
          <a
            ...
            class="flex items-center gap-2 text-sm font-medium text-emerald-600  hover:text-emerald-700  transition-colors"
          >
      ...
      <div class="mt-8 pt-5 border-t border-gray-200  text-center">
        <p class="text-xs text-gray-400 ">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="font-semibold hover:text-gray-600  transition-colors"
          >
            QeSuite
          </a>
        </p>
